...
using SmartClass.Sessions;
using SmartClass.Web.Models.Account;
using SmartClass.Web.Views.Shared.Components.TenantChange;

namespace SmartClass.Web.Controllers
{
    public class AccountController : SmartClassControllerBase
    {
